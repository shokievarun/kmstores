...
public class AdminUsersProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView backimage =(ImageView)findViewById(R.id.back_arrow_uupa);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull Cart model) {
                ...
                holder.txtProductRate.setText("Rate "+model.getPrice()+" Rs/-");
                holder.txtProductName.setText(model.getPname());
                int oneProductSum=((Integer.valueOf(model.getPrice()))*Integer.valueOf(model.getQuantity()));
                holder.txtProductSumPrice.setText("Price "+oneProductSum+" Rs/-");
