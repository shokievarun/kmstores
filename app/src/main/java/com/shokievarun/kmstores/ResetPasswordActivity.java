...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    private Button verifyBtn,updatePasswordBtn;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        updatePasswordBtn=findViewById(R.id.fg_btn);


        check = getIntent().getStringExtra("check");


        ImageView backimage =(ImageView)findViewById(R.id.back_arrow_reset);
        ...
        updatePasswordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ResetPasswordActivity.this,PhoneNoActivity.class);
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (snapshot.exists()) {
                        ...
                        if (snapshot.hasChild("Security Questions")) {
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                Intent intent=new Intent(ResetPasswordActivity.this,SecondLoginActivity.class);
                                                                startActivity(intent);
                                                            }
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "You have not set the security questions. Please Contact 8884879145 ", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
                        Toast.makeText(ResetPasswordActivity.this, " Phone number is incorrect or doesn't exist ", Toast.LENGTH_SHORT).show();
                    }
                }
